jQuery("#simulation")
  .on("click", ".s-800bed0d-187d-4693-be12-07ed7db86989 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-800bed0d-187d-4693-be12-07ed7db86989 #s-Input_3 input": {
                      "attributes": {
                        "color": "#808080"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-checkbox","#s-Input_5","#s-Line_1" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Text_11","#s-Text_8","#s-Image_1","#s-Image_57","#s-Rectangle_3","#s-Text_9","#s-Text_6","#s-Text_10","#s-Image_21","#s-Image_56","#s-Image_6" ],
                    "effect": {
                      "type": "slide",
                      "duration": 500,
                      "direction": "left"
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Text_11","#s-Text_8","#s-Image_57","#s-Image_1","#s-Rectangle_3","#s-Text_9","#s-Text_10","#s-Text_6","#s-Image_21","#s-Image_56","#s-Image_6" ],
                    "effect": {
                      "type": "slide",
                      "duration": 500,
                      "direction": "left"
  ...
  .on("pageload", ".s-800bed0d-187d-4693-be12-07ed7db86989 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Image_57","#s-Text_11","#s-Image_56","#s-Image_6","#s-Text_9","#s-Text_8","#s-Text_6","#s-Rectangle_3","#s-Text_10","#s-Image_1","#s-Image_21" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }

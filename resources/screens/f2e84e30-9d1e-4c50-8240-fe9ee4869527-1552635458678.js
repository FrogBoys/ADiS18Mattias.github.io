              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Image_6","#s-Image_1","#s-Image_21","#s-Text_22","#s-Image_56","#s-Text_19","#s-Text_20","#s-Text_21","#s-Rectangle_2" ],
                    "effect": {
                      "type": "slide",
                      "duration": 500,
                      "direction": "left"
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Text_22","#s-Text_19","#s-Image_6","#s-Rectangle_2","#s-Image_56","#s-Image_21","#s-Text_21","#s-Image_1","#s-Text_20" ],
                    "effect": {
                      "type": "slide",
                      "duration": 500,
                      "direction": "left"

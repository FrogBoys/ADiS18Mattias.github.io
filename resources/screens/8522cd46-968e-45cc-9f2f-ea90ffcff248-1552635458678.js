              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Image_6","#s-Image_1","#s-Image_21","#s-Text_6","#s-Image_56","#s-Text_1","#s-Text_2","#s-Text_5","#s-Rectangle_3" ],
                    "effect": {
                      "type": "slide",
                      "duration": 500,
                      "direction": "left"
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Text_5","#s-Text_2","#s-Text_1","#s-Image_1","#s-Text_6","#s-Image_56","#s-Image_6","#s-Rectangle_3","#s-Image_21" ],
                    "effect": {
                      "type": "slide",
                      "duration": 500,
                      "direction": "left"
